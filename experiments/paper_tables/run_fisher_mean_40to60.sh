#!/bin/bash
# run_fisher_mean_40to60.sh
# Prune 40% to 60%, fine-tune 90 epochs, using global_fisher (fisher mean)
...
# 依照您的要求，輸出到新的資料夾
OUTPUT_DIR="experiments/paper_tables/results/FISHER mean layer importance result"
...
BASE_LR=1e-4
FINE_TUNE_LR=1e-4
FREEZE_EPOCH=88    # 90 - 2 = 88 (last two epochs)
FREEZE_LR=5e-7
...
PY
    ...
    echo "allocation_strategy: global_fisher (fisher mean)"
...
# "D:\UFALP\resnet50\experiments\paper_tables\run_fisher_mean_40to60.sh"