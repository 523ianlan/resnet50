"""Ablation: Stage 2 first-order mode comparison."""
...
def main():
    parser = argparse.ArgumentParser(description="Stage2 first-order mode ablation")
    parser.add_argument("--config", type=str, default=None)
    parser.add_argument("--save-root", type=str,
                        default="./experiments/ablations/results/stage2_first_order")
