"""Ablation: Stage 1 numeric stability switches."""
...
def main():
    parser = argparse.ArgumentParser(description="Stage1 stability ablation")
    parser.add_argument("--config", type=str, default=None)
    parser.add_argument("--save-root", type=str,
                        default="./experiments/ablations/results/stage1_stability")
